...
/* user/show.html.twig */
class __TwigTemplate_88a86541f14ad2ad57bb9ecb0dd3843fc07675196e2fec8344c66eb62804c3cf extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 28, $this->source); })()), "psedo", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "/var/www/html/symfBlog/templates/user/show.html.twig");
    }
}
