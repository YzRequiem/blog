...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'articles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'commentaires', '' . "\0" . 'App\\Entity\\User' . "\0" . 'psedo', '' . "\0" . 'App\\Entity\\User' . "\0" . 'isVerified'];
        }
    ...
    public function getPsedo(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPsedo', []);

        return parent::getPsedo();
    }

    /**
     * {@inheritDoc}
     */
    public function setPsedo(string $psedo): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPsedo', [$psedo]);

        return parent::setPsedo($psedo);
    }
